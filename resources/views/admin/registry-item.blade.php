<div class="flex items-center justify-between p-4 rounded border-2 my-2">
    ...
    <div class="flex flex-col">
        ...
        <a href="{{ route('registry.export', ['registry' => $registry[0]->id])}}" class="px-4 py-2 rounded border-2 border-[#9ec4c5] text-[#9ec4c5]">Export <i class="fa-solid fa-download"></i></a>
    </div>
</div>
